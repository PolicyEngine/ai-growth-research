...
the state layer is not a rounding error --- it is most of the gap between
the \genKeptMatchedRapidPct\% federal keep-rate and the
\genKeptHouseholdRapidPct\% household one: \genRapidPropState B under
...
on the federal basis, \genKeptHouseholdRapidPct\% once states and transfers
are counted, and turns growth's poverty gain into a marginal loss; the
wage-distribution assumption nobody can yet pin down flips the household
verdict while the revenue verdict stands; and the channels a tax-only model omits --- automatic transfers and
