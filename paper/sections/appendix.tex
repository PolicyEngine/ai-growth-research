...
the reconciliation reads it directly. Their PUF-based input microdata cannot
be redistributed, so their pipeline is readable but not rerunnable by third
parties; this paper's is both.
