...
(build~p) and \texttt{ai\_scenarios\_buildo.json} (build~o, for the stability
comparison of Section~\ref{sec:stability}) are committed, so every value and
table in this paper regenerates from the repository alone --- the full
simulation need only be rerun to change a scenario, not to check a number.
