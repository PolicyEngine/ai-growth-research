...
\genRapidShareKeptPct\% of the revenue (\genRapidPropRev B) and erases the
poverty gain (\genRapidPropPovPp pp).

Second, the assumption the forecasting literature is least sure of --- whether
AI compresses or widens the wage distribution --- decides the household
verdict while leaving the revenue verdict intact. Across the Budget Lab's own
...
retirement accounts --- revenue falls roughly linearly, and below a
\genRealBreakevenPct\% realized share the household sector loses money on
Rapid AI growth; poverty, meanwhile, sits still to within
\genRealPovMaxPct$-$\genRealPovMinPct~pp across the whole sweep. And whether
...
share machinery --- payroll responses agree closely in every cell, two
independent wage distributions meeting the same taxable maximum --- and
...
concentrated in the income-tax response to the capital shock
(\genIITRatioProp$\times$ on the cell where the wage-spread channel is
neutral), consistent with a larger realized-capital base and a more
