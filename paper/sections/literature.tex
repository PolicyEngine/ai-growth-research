...
2030 growth and factor-share scenarios, add stylized wage-distribution
variants, and score them through a federal individual income and payroll tax
microsimulation built on the IRS Public Use File, with a corporate revenue
wedge outside the microsimulation. Their central finding --- that growth
accruing to capital raises less revenue than the same growth at fixed factor
shares, by roughly a factor of two in the Rapid scenario --- is the claim
this paper re-derives on independent machinery and extends to transfers,
poverty and states. \citet{karger2026} elicit forecasts from economists,
AI-company staff, policy researchers, superforecasters and the public; the
median respondent expects modest GDP acceleration by 2030, a declining labor
share, and rising wealth inequality, with wide disagreement across groups
about outcomes under rapid progress. The survey does not elicit a
wage-distribution outcome; the compressive-to-expansive axis is the Budget
Lab's stylization of that open question, which this paper propagates rather
than resolves. \citet{acemoglu2025} argues on task-level grounds for modest
...
employment, wage and capital-income shocks through the Irish SWITCH model,
and
