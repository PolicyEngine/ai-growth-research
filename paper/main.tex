...
\input{values_generated} % machine-generated numeric macros from run outputs
\input{tables_generated} % machine-generated tables from run outputs
...
\genKeptHouseholdRapidPct\% once state taxes and transfers are counted
